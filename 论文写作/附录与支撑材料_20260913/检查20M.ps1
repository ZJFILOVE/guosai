...
$taskZip = Get-Item -LiteralPath (Join-Path $PSScriptRoot '支撑材料.zip') -ErrorAction Stop
$taskRaw = (Get-ChildItem -LiteralPath (Join-Path $PSScriptRoot '支撑材料') -File -Recurse | Measure-Object -Property Length -Sum).Sum
